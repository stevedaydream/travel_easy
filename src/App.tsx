                        ...
                        <div className="w-full space-y-2 flex flex-col items-center">
                          ...
                          <div className="flex gap-1.5 text-[8px] mt-1">
                            {immigrationQr.driveLink && (
                              <a href={immigrationQr.driveLink} target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">雲端</a>
                            )}
                    ...
                    <div className="bg-[#FAF8F5] border border-[#EADEC6] rounded-xl p-2.5 flex flex-col items-center justify-between text-center relative min-h-[140px]">
                      {customsQr.base64 ? (
                        <div className="w-full space-y-2 flex flex-col items-center">
                          ...
                          <div className="flex gap-1.5 text-[8px] mt-1">
                            {customsQr.driveLink && (
                              <a href={customsQr.driveLink} target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">雲端</a>
                            )}
